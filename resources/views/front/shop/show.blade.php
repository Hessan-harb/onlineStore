                    ...
                    <div class="product-sidebar">
                        ...
                        <div class="single-widget condition">
                            <form action="{{URL::current()}}" method="get">
                                <h3 for="price_range">Select Price Range</h3>
                                <select class="form-range" name="price_range" id="price_range">
                                    <option value="0_100L">$0 - $100L ({{$products->count()}})</option>
                                    <option value="100L_500">$100L - $500 ({{$products->count()}})</option>
                                    <option value="500_1000">$500 - $1,000 ({{$products->count()}})</option>
                                    <option value="1000_5000">$1,000 - $5,000 ({{$products->count()}})</option>
                                </select><br>
                            ...
                            <div class="row align-items-center">
                                <div class="col-lg-7 col-md-8 col-12">
                                    <div class="product-sorting">
                                        ...
                                        <h3 class="total-show-product">Showing: <span>1 - {{$categoryWithProducts->products->count()}}</span></h3>
                                    </div>
                                </div>
